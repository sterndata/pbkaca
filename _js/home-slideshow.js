/*$(document).ready(function() {
    $('#website-attributes').fadeIn(1500);
    $('#home-splash').fadeIn(1500);
});
 */
 ...
 */
 (function( $, undefined ) {
    ...
    var defaults = {
        ...
        auto: 4000,                 // Autoplay timeout in milliseconds. Set to false for no autoplay.
    ...
    Slides.prototype._init = function() {
        ...
        if ( this.opts.pagination ) {
            ...
            for ( var i = 0, len = this.count; i < len; i++ ) {
                this.$pagination.append('<li><a href="#" data-slides="' + i + '"><span>.</span></a></li>');
            }
        ...
        // Create skip links
        if ( this.opts.skip ) {
            this.$prev = $('<a href="#" class="slides-prev" data-slides="previous">&nbsp;</a>');
            this.$next = $('<a href="#" class="slides-next" data-slides="next">&nbsp;</a>');
